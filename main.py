...
# ოპტიმიზირებული აქტივების სია: 60 აქტივი (30 კრიპტო, 18 აქცია, 12 საქონელი)
...
STOCKS = [
    ...
    "UNH", "JNJ", "WMT", "HD", "XOM", "CVX", "AMD", "INTC"
]

# 12 საქონელი (20%)
COMMODITIES = [
    "GC=F", "SI=F", "CL=F", "NG=F",  # ოქრო, ვერცხლი, ნავთობი, გაზი
    "ZC=F", "ZW=F", "ZS=F",  # სიმინდი, ხორბალი, სოია
    "ES=F", "NQ=F",  # S&P 500, Nasdaq futures
    "DX=F", "6E=F", "HG=F"  # Dollar Index, Euro, სპილენძი
]

ASSETS = CRYPTO + STOCKS + COMMODITIES

INTERVAL = "1h"
SCAN_INTERVAL = 90  # 1.5 წუთიანი პაუზა სრული ციკლის შემდეგ
ASSET_DELAY = 4  # 4 წამიანი პაუზა თითოეულ აქტივს შორის (60 აქტივი × 4წმ = 4წთ ერთ ციკლში)
